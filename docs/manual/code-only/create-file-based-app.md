...
`ProgramEngineOnly.cs` in the same folder is the scene with no toolkit package at all - see
[Create a File-Based App - Engine Only](create-file-based-app-engine-only.md).