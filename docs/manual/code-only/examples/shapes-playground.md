...
plane with world text on them, genuinely thick 3D lines and wire boxes, camera-facing billboards, pie wedges, donut
...
- World text laid onto a shape panel with WorldTextComponent, including a live counter
...
[!code-csharp[](../../../../examples/code-only/Example_Shapes_Playground/Program.cs?start=1&end=548)]
