...
Console.WriteLine();
Console.WriteLine("Copy it next to whatever project should consume these packages, then reference them");
Console.WriteLine("as any consumer would, for example:");
