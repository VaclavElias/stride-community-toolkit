...
public sealed class ChartGridOptions
{
    ...
    /// <summary>Which coordinate planes carry a grid. Defaults to <see cref="ChartGridPlanes.XY"/>; a flat chart ignores the other planes. Live.</summary>
    ...
    /// <summary>Width of the major grid lines in pixels. Defaults to <c>1</c>.</summary>
    ...
    /// <summary>Width of the minor grid lines in pixels. Defaults to <c>1</c>.</summary>
