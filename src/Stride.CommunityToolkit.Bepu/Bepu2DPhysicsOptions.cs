...
/// <see cref="Body2DComponentOld"/> having an empty <see cref="CompoundCollider"/>. Although termed "2D", simulation occurs
...
{
    /// <summary>
    /// Gets or sets the Bepu collidable component to attach. Defaults to a new <see cref="Body2DComponentOld"/> with an empty
