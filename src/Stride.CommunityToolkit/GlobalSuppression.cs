...
[assembly: SuppressMessage("NDepend", "ND1305:AvoidNamespacesWithFewTypes", Target = "Stride.CommunityToolkit:Stride.CommunityToolkit.Rendering.Compositing", Justification = "Three types: GraphicsCompositorExtensions, used by twelve examples, and the two helpers a processor or renderer needs to work in Game Studio; mirrors Stride.Rendering.Compositing.")]
...
// Stride's effect source generator emits one static ShaderMixins class per .sdfx namespace; the name is the generator's, not ours, and every package with an effect file gets one.
[assembly: SuppressMessage("NDepend", "ND2012:AvoidHavingDifferentTypesWithSameName", Target = "Stride.CommunityToolkit.Effects:Stride.CommunityToolkit.Effects.Picking.ShaderMixins", Justification = "Generated by Stride's effect source generator for GpuPickingEffect.sdfx, one per package that ships an effect file; the Shapes package has the same generated class for ShapeEffect.sdfx.")]
// --- Gallery stations and engine field shapes (2026-09-13) ------------------------------------
// The gallery frame in Example.Common instantiates its station type through the generic new() constraint of Gallery<TStation>, which static analysis cannot see.
[assembly: SuppressMessage("NDepend", "ND1207:NonStaticClassesShouldBeInstantiatedOrTurnedToStatic", Target = "E09_3D_Particles_Gallery:E09_3D_Particles_Gallery.ParticleStation", Justification = "Instantiated by Gallery<ParticleStation> through its new() constraint, which static analysis cannot see.")]
[assembly: SuppressMessage("NDepend", "ND1207:NonStaticClassesShouldBeInstantiatedOrTurnedToStatic", Target = "E11_3D_ShapeBatch_Gallery:E11_3D_ShapeBatch_Gallery.ShapeStation", Justification = "Instantiated by Gallery<ShapeStation> through its new() constraint, which static analysis cannot see.")]
// The particle gallery brought Stride.Particles.Updaters.FieldShapes into the analysed graph; its Cube, Cylinder and Sphere are the engine's names for force-field volumes, and the debug-shape structs took the same primitive names years earlier. Neither side is renamed for the other.
[assembly: SuppressMessage("NDepend", "ND2012:AvoidHavingDifferentTypesWithSameName", Target = "Stride.CommunityToolkit.DebugShapes:Stride.CommunityToolkit.DebugShapes.Code.Cube", Justification = "Clashes only with the engine's particle field-shape volume of the same name; the debug shape predates it in the toolkit and is used by name in the examples.")]
[assembly: SuppressMessage("NDepend", "ND2012:AvoidHavingDifferentTypesWithSameName", Target = "Stride.CommunityToolkit.DebugShapes:Stride.CommunityToolkit.DebugShapes.Code.Cylinder", Justification = "Clashes only with the engine's particle field-shape volume of the same name; the debug shape predates it in the toolkit and is used by name in the examples.")]
[assembly: SuppressMessage("NDepend", "ND2012:AvoidHavingDifferentTypesWithSameName", Target = "Stride.CommunityToolkit.DebugShapes:Stride.CommunityToolkit.DebugShapes.Code.Sphere", Justification = "Clashes only with the engine's particle field-shape volume of the same name; the debug shape predates it in the toolkit and is used by name in the examples.")]